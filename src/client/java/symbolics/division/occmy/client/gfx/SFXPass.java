...
public abstract class SFXPass {
    protected GpuTexture swap = ProjectionRenderer.makeTexture(100, 100);
    protected GpuTextureView swapView = RenderSystem.getDevice().createTextureView(swap);
    protected String purpose = "occmy post render pass";
    ...
    public void apply(Framebuffer buffer) {
        ...
        applyPass(buffer, shapeIndexBuffer, gpuBuffer);
    ...
    protected abstract void applyPass(Framebuffer buffer, RenderSystem.ShapeIndexBuffer quadIndexBuffer, GpuBuffer quadBuffer);
}
